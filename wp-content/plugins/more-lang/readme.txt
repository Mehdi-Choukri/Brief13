...
Tags: multilingual, multilanguage, i18n, localization, translation, language, bilingual, international, language switcher, morelang
...
* The premium add-on [More-Lang Pro](https://www.morelang.com "More-Lang Pro") provides support for WooCommerce, and Post-related plugins like Elementor, Yoast SEO, etc.

= How to translate text without an in-place editor? =

More-Lang provides in-place editors as far as possible. If it does not provide in some cases(e.g., the Name of a Custom Field), you can translate in the "Translations" page,
...
4. Posts: Multilingual "Excerpt" & "Custom Fields" editor.
