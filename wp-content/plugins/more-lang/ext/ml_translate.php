...
?>
	<div id="ml-trans-wrap">
		...
		<div class="notice notice-info is-dismissible">
			<?php
			esc_html_e('More-Lang provides in-place editors as far as possible. If it does not provide in some cases', ML_TDOMAIN);
			echo '<i>' . esc_html__(' (e.g. the Name of a Custom Field)', ML_TDOMAIN) . '</i>';
